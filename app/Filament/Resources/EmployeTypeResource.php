...
use App\Filament\Resources\EmployeTypeResource\Pages;
use App\Filament\Resources\EmployeTypeResource\RelationManagers;
...
class EmployeTypeResource extends Resource
{
    protected static ?string $model = EmployeType::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                //
                TextInput::make('name')
                    ->label('Employe Type Name')
                    ->placeholder('Input Employe Type Name')
                    ->minLength(2)
                    ->required()
                    ->maxLength(255)
                    ->columnSpan(2),
    ...
    {
        return [
            'index' => Pages\ListEmployeTypes::route('/'),
